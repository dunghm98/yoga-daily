...
@section('admin-content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <!-- /Page Header -->
            <form action="{{ route('course.storeLesson') }}" method="post">
                @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="#">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input name="link" value="{{ old('link') }}" type="text" class="form-control" placeholder="Link video">
                                        @error('link')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input name="order" value="{{old('order')}}" type="number" class="form-control">
                                        @error('order')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input name="energy" value="{{ old('energy') }}" type="number" class="form-control">
                                        @error('energy')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
