...
@section('content')
    ...
    <section id="feat">
        <div class="container">
            <h2 class="main_title"><em></em>Yoga Dành Cho Bạn<span>Hãy thực hành yoga để khiến bạn tràn ngập hy vọng và sự lạc quan </span></h2>
            <p class="lead styled">
                Trên khắp thế giới ngày nay người ta ngày càng nhận thức sâu sắc rằng các phương pháp trị liệu bằng rèn luyện sức khỏe hữu ích hơn là các phương pháp chữa bệnh chính thống.
                Hãy để cho những tinh túy của môn yoga đến với tất cả các bạn.
            </p>
            <div class="row">
                <div class="col-sm-4 wow fadeIn animated" data-wow-delay="0.2s">
                    <div class="box_feat" id="icon_2">
                        <h3>Videos Tập Luyện</h3>
                        <p>Dễ dàng thực hiện với video hướng dẫn chi tiết. Học online giúp sắp xếp thời gian linh hoạt hơn. </p>
                    </div>
                </div>
                <div class="col-sm-4 wow fadeIn animated" data-wow-delay="0.5s">
                    <div class="box_feat" id="icon_1">
                        <h3>Phù Hợp Mọi Lứa Tuổi</h3>
                        <p>Phù hợp với mọi lứa tuổi, mọi tình trạng thể lực và mọi trình độ - từ người mới bắt đầu học đến người ở trình độ  nâng cao. </p>
                    </div>
                </div>
                <div class="col-sm-4 wow fadeIn animated" data-wow-delay="1s">
                    <div class="box_feat" id="icon_3">
                        <h3>Xem Ở Mọi Nơi</h3>
                        <p>Chỉ cần có điện thoại máy tính bảng, laptop hoặc TV kết nối Internet. </p>
                    </div>
                </div>
            </div>
            <!-- End row -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="lead">Không ép buộc thời gian, không gò bó về không gian, bạn có thể tập yoga bất cứ đâu như văn phòng, bãi biển, đồi núi, bờ suối… và bất cứ thời điểm nào trong ngày, chỉ cần một chiếc smartphone hoặc laptop có kết nối internet là mọi thứ có thể giải quyết.<p>
                    <p>Cho phép bạn tập luyện trong môi trường thoải mái, có thể là sân thượng nhà bạn hoặc phòng riêng nhà bạn, mơi mà bạn cảm thấy thoải mái nhất. Và đặc biệt không cần phải trang bị những bộ đồ tập chất lượng như khi đến phòng tập mà bạn có thể mang bất cứ đồ gì miễn sao bạn cảm thấy thoải mái nhất là được.</p>
                    <div id="compatib">
                        Tương thích với cả Android/IOS
                    </div>
                </div>
                <div class="col-md-6">
